...
namespace GameStateManagement
{
    ...
    class GameplayScreen : GameScreen
    {
        ...
        // Camera stuff
        Camera camera;
        enum CameraTypes { LevelEditor, Simulation };
                                                       ...
                                                       bool coveredByOtherScreen)
        {
            ...
            if (IsActive)
            {
                // Update SimulationCamera if needed
                if (cameraType == CameraTypes.Simulation)
                {
                    camera.updateCamera(m_kShip);
                    CameraMatrix = camera.m_CameraMatrix;
                }
        ...
        private void changeCamera()
        {
            if (cameraType == CameraTypes.LevelEditor)
            {
                ...
                camera = new SimulationCamera(ScreenManager.Game, m_kShip);
                CameraMatrix = camera.m_CameraMatrix;
                ProjectionMatrix = camera.m_ProjectionMatrix;
