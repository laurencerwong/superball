    ...
    class GameplayScreen : GameScreen
    {
		...
		public override void HandleInput(InputState input, GameTime gameTime)
        {
            ...
            else
            {
                ...
                {
                    Vector2 unprojectedMousePos = new Vector2((float)Mouse.GetState().X - 512.0f, (float)Mouse.GetState().Y);
                    unprojectedMousePos.Y -= 384.0f;
                    unprojectedMousePos.Y *= -1;
                    spawnManager.placeHammer(unprojectedMousePos.X, unprojectedMousePos.Y, 0.0f);
                }
            }
        }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(gameFont, "X " + mousePos.X.ToString() + " " + mousePos.Y.ToString(), mousePos, Color.Green);
            spriteBatch.DrawString(gameFont, "Level: " + (spawnManager.gCurrentLevel + 1).ToString(), playerPosition, Color.Green);
            Vector2 hammerText = new Vector2(playerPosition.X, playerPosition.Y + 30);
            spriteBatch.DrawString(gameFont, "Hammers: " + spawnManager.gAllowedHammers.ToString(), hammerText, Color.Green);
            Vector2 springText = new Vector2(hammerText.X, hammerText.Y + 30);
            spriteBatch.DrawString(gameFont, "Springs: " + spawnManager.gAllowedSprings.ToString(), springText, Color.Green);
            Vector2 platformText = new Vector2(springText.X, springText.Y + 30);
            spriteBatch.DrawString(gameFont, "Platforms: " + spawnManager.gAllowedPlatforms.ToString(), platformText, Color.Green);
