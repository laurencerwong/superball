...
namespace GameStateManagement
{
    ...
    public class SpawnManager : Microsoft.Xna.Framework.GameComponent
    {
        ...
        private void CreateAsteroid()
        {
            ...
            Matrix m_mTempMatrix2 = m_TempAsteroid.body.WorldTransform;
            m_mTempMatrix2.Translation = m_mTempMatrix.Translation;
            m_TempAsteroid.body.WorldTransform = m_mTempMatrix;
//            m_TempAsteroid.body.ApplyForce(m_TempAsteroid.vForce, m_TempAsteroid.vForce.);
