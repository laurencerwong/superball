...
namespace GameStateManagement
{
    ...
    class PauseMenuScreen : MenuScreen
    {
        ...
        GameplayScreen.CameraTypes prevType;
            ...
            : base("Paused")
        {
            ...
            prevType = GameplayScreen.cameraType;
            GameplayScreen.cameraType = GameplayScreen.CameraTypes.None;
        ...
        {
            GameplayScreen.cameraType = prevType;
            base.OnCancel();
        }
